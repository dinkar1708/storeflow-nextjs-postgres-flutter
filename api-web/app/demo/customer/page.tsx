...
const products = [
  {
    ...
    price: 149.99,
    stock: 24,
    blurb: 'Noise-cancelling, 30h battery',
  },
  {
    id: 'p2',
    name: 'Cotton Tee',
...
const wishlist = [
  { name: 'LED Desk Lamp', price: 45.0, category: 'Home' },
  { name: 'Yoga Mat', price: 39.0, category: 'Fitness' },
];

const orders = [
  { id: 'ORD-9421', date: '2026-04-28', total: 189.97, status: 'SHIPPED' },
  { id: 'ORD-9389', date: '2026-04-21', total: 79.0, status: 'DELIVERED' },
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
          ...
          <div className="flex items-end justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Search, filter by category, view stock in real time.
              </p>
            </div>
            <div className="hidden sm:flex gap-2">
              <input
                ...
                className="px-3 py-2 border rounded-md bg-white text-sm w-48"
              />
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t">
                    ...
                    <div className="flex gap-2">
                      <button className="px-3 py-2 rounded-md font-medium bg-white border border-purple-300 text-purple-700">
                        ♥
                      </button>
                      <button
                        className={`px-4 py-2 rounded-md font-medium ${p.stock > 0 ? 'bg-green-600 text-white' : 'bg-gray-300 text-gray-500'}`}
                      >
                        {p.stock > 0 ? 'View' : 'Out of Stock'}
                      </button>
                    </div>
                  </div>
                </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <button className="mt-4 w-full px-4 py-3 bg-green-600 text-white rounded-md font-medium">
              Checkout
            </button>
          </div>
              ...
              {wishlist.map((w) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button className="px-3 py-1.5 bg-green-600 text-white text-sm rounded-md">
                      Add to cart
                    </button>
                  </div>
                </div>
                ...
                {orders.map((o) => (
                  <tr key={o.id}>
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium ${statusColor[o.status]}`}
                      >
                        {o.status}
                      </span>
                    </td>
